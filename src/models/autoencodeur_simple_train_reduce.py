...
# define model
inputs = Input(shape=(nfeatures, ), name = 'input')
e = MyGaussianNoise([0.03, 0.02, 0.007, 0.003, 0, 0, 0, 0, 0, 0])(inputs) # 0.03
e = Dense(nfeatures // 2, name = 'encoder_l1')(e)
#e = Dropout(rate = 0.2, name = 'drop1')(e)
e = BatchNormalization(name = 'batchnorm1')(e)
e = LeakyReLU(name = 'leakyrelu1')(e)
e = Dense(nfeatures // 3, name = 'encoder2')(e)
#e = Dropout(rate = 0.2)(e)
e = BatchNormalization(name = 'batchnorm2')(e)
e = LeakyReLU(name = 'leakyrelu2')(e)
#e = Dropout(rate = 0.2)(e)
bottleneck = Dense(nfeatures // 4, name = 'output')(e)
#d = Dropout(rate = 0.2)(bottleneck)
d = Dense(noutputs  // 3)(bottleneck)
d = BatchNormalization()(d)
d = LeakyReLU()(d)
# decoder level 2
d = Dense(noutputs // 2)(d)
...
reduce_learning_rate = ReduceLROnPlateau(monitor = 'val_loss',
                               ...
                               #cooldown = 2,						
                               verbose = 1)
checkpoint = ModelCheckpoint(path + '/autoencodeur_reduce_checkpoint_' + fichier_suffixe + '.keras', 
                                save_best_only=True, 
                                monitor='val_loss',
                                mode='min',
                                verbose = 1)
...
pd.DataFrame(history.history).to_csv(path + '/autoencodeur_reducte_history_' + fichier_suffixe + '.csv', sep = ';', index = False)
